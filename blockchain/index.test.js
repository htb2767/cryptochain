...
describe('Blockchain',()=>{
    ...
    describe('isValidChain()',()=>{
        ...
        describe('when the chain starts with genesis',()=>{
            beforeEach(()=>{
    ...
    describe('validTransactionData()',()=>{
        ...
        describe('and the transaction data has multiple rewards',()=>{
            it('retruns false and logs an error',()=>{
        ...
        describe('and the transaction data has at least one malformed outputMap',()=>{
            describe('adn the transaction is not a reward transaction',()=>{
                it('retruns false and logs an error',()=>{
            ...
            describe('adn the transaction is  a reward transaction',()=>{
                it('retruns false and logs an error',()=>{
