...
describe('transaction',()=>{
    ...
    describe('validTransaction()',()=>{
        ...
        describe('when the transaction is invalid',()=>{
            ...
            describe('and a transaction input value is invalid',()=>{
                it('returns false and logs an error',()=>{
    ...
    describe('update()',()=>{
        ...
        describe('and the amount is valid',()=>{
            ...
            it('outputs the amount to the next reci[ient',()=>{
                expect(transaction.outputMap[nextRecipient]).toEqual(nextAmount);
    
            });
            it('substract the amount form the original sender output amount',()=>{
            ...
            describe('and antoher update for the same recipient',()=>{
                let addedAmount;
                beforeEach(()=>{
                    addedAmount=80;
                    transaction.update({senderWallet,recipient:nextRecipient,amount:addedAmount});
                });
                it('adds the recipient amount',()=>{
    ...
    describe('rewardTransaction()',()=>{
        ...
        it('creates a transaction with a reward input',()=>{
